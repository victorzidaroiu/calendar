...
"use strict";function _classCallCheck(a,b){if(!(a instanceof b))throw new TypeError("Cannot call a class as a function")}var _createClass=function(){function a(a,b){for(var c=0;c<b.length;c++){var d=b[c];d.enumerable=d.enumerable||!1,d.configurable=!0,"value"in d&&(d.writable=!0),Object.defineProperty(a,d.key,d)}}return function(b,c,d){return c&&a(b.prototype,c),d&&a(b,d),b}}(),CALENDAR=function(){function a(a){p.innerHTML="",q.innerHTML="",k=[],l=[],a.forEach(f),d(),b()}function b(){for(var a=0;a<=2*o;a++){var b=document.createElement("div"),d=c(60*n+30*a),e=d.hour>=n&&d.hour<12?"AM":"PM";b.innerHTML=d.hour+": "+d.minutes+" "+e,"00"===d.minutes?b.className="fullHour":b.className="halfHour",q.appendChild(b)}}function c(a){return{hour:Math.floor(a/60)>13?Math.floor(a/60)-12:Math.floor(a/60),minutes:a%60||"00"}}function d(){l.sort(function(a,b){return a.events.length>b.events.length?0:a.events.length<b.events.length?1:0}),l.forEach(function(a){a.print();var b=[],c=[],d=m/a.events.length;a.events.forEach(function(a){k[a].isDrawn?(d=k[a].width,c.push(a)):b.push(a)});var f=0;b.forEach(function(a){for(var b=d*f,g=e(b,b+d,c);!g;)f+=1,b=d*f,g=e(b,b+d,c);k[a].width=d,k[a].left=d*f,f+=1,h(k[a])})})}function e(a,b,c){var d=!0;return c.forEach(function(c){b>k[c].left&&a<k[c].left+k[c].width&&(d=!1)}),d}function f(a){console.log("Adding event:"),console.log(a),console.log("------------"),a.isDrawn=!1,a.width=600,a.left=0,k.push(a),k[k.length-1].index=k.length-1,a.index=k.length-1;var b=!1;l.forEach(function(c){c.collidesWith(a.index)&&(c.addEvent(a.index),b=!0)}),b||l.push(new r(a.index))}function g(a,b){return a.end>=b.start&&a.start<=b.end}function h(a){var b=document.createElement("div"),c=document.createElement("div");c.className="eventText",c.innerHTML=a.name||"Sample Item",b.style.top=a.start,b.style.width=a.width,b.style.left=a.left,b.style.height=a.end-a.start,b.appendChild(c),p.appendChild(b),k[a.index].isDrawn=!0}function i(){for(var b=arguments.length>0&&void 0!==arguments[0]?arguments[0]:5,c=[],d=0;d<b;d++){var e=j(0,690),f=j(e+30,720);c.push({start:e,end:f})}a(c)}function j(a,b){return Math.floor(Math.random()*(b-a)+a)}var k=[],l=[],m=600,n=9,o=12,p=document.querySelector(".calendarEvents"),q=document.querySelector(".calendarHours"),r=function(){function a(b){var c=this;_classCallCheck(this,a),this.chain=[b],k.forEach(function(a){b!=a.index&&c.collidesWith(a.index)&&c.addEvent(a.index)})}return _createClass(a,[{key:"print",value:function(){console.log("Printing chain: "),this.chain.forEach(function(a){console.log(k[a])}),console.log("-----------------")}},{key:"addEvent",value:function(a){this.chain.push(a)}},{key:"collidesWith",value:function(a){var b=!0;return this.chain.forEach(function(c){g(k[a],k[c])||(b=!1)}),b}},{key:"events",get:function(){return this.chain}}]),a}();window.layOutDay=a,window.generateRandomEvents=i};window.onload=function(){CALENDAR(),layOutDay([{start:30,end:150},{start:540,end:600},{start:560,end:620},{start:610,end:670}])};